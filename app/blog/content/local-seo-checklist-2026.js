export default function PostContent() {
  return (
    <>
      ...
      <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">1. Claim and complete your Google Business Profile</h2>
      <p className="mb-4">
        This is the single biggest local SEO lever. If you haven't claimed your Google Business Profile (formerly Google My Business) at <a href="https://business.google.com" target="_blank" rel="noopener" className="text-blue-600 hover:underline">business.google.com</a>, do that today. Complete every field — primary category, all relevant secondary categories, service areas, hours, attributes, photos, products, services.
      </p>
      <p className="mb-4">
      ...
      <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">2. NAP consistency everywhere</h2>
      <p className="mb-4">
      ...
      <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">3. Build a real review pipeline</h2>
      <p className="mb-4">
        Reviews are the second-biggest local ranking factor after Google Business Profile completeness. The trick isn't getting a big batch of reviews once — it's getting reviews <em>consistently</em>. Google's algorithm cares about recency.
      </p>
      <p className="mb-4">
      ...
      <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">4. One page per service, one page per location</h2>
      <p className="mb-4">
      ...
      <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">5. Schema markup for local business</h2>
      <p className="mb-4">
      ...
      <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">6. Page speed (yes, again)</h2>
      <p className="mb-4">
        Your site needs to load fast on mobile. Run <a href="https://pagespeed.web.dev" target="_blank" rel="noopener" className="text-blue-600 hover:underline">PageSpeed Insights</a> on your homepage. Aim for 80+ mobile. If you're below 60, you're being actively penalized. The biggest culprits: unoptimized images, slow hosting, and bloated theme/page-builder code.
      </p>

      <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">7. Local link building</h2>
      <p className="mb-4">
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>Chamber of commerce membership listing</li>
        <li>Local industry association directory</li>
        <li>Local sponsorships (Little League, community events, charity)</li>
        <li>Press from any local newspaper or blog you can get</li>
      </ul>
      <p className="mb-4">
        Skip the spammy directory sites that email you. They don't help.
      </p>

      <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">8. Content that answers local questions</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        If you sell a service where customers do math before buying, build a calculator. See{' '}
        ...
        as examples of how interactive tools rank and convert in service categories.
      </p>

      <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">9. Track everything</h2>
      <p className="mb-4">
      ...
      <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">10. Be patient, then audit</h2>
      <p className="mb-4">
      ...
      <h2 className="text-3xl font-bold text-gray-900 mt-12 mb-4">The 90/10 version</h2>
      <p className="mb-4">
        If you can only do three things this month:
      </p>
      <ol className="list-decimal pl-6 mb-4 space-y-2">
        <li><strong>Complete your Google Business Profile</strong> — every field, 30+ photos.</li>
        <li><strong>Set up a review request workflow</strong> — text customers with a direct link the day after the job.</li>
        <li><strong>Make sure NAP is consistent</strong> across your top 10 listings.</li>
      </ol>
      <p className="mb-4">
